...
NuGet packages can be installed for extensions to to the builder, for example adding console in the below statement ```loggingBuilder.AddConsole();``` would require installing the package ```ConsoleLoggerExtensions```
