...
When doing work on this package, <h3>_**make sure**_</h3> to manually the packages in nuget for any that are deprecated. 
...
Until an NVD checker is put in place, please <h3>_**ensure**_</h3> that packages are checked for deprecated versions to avoid any further vulnerabilities.
